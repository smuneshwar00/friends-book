...
export class HomeComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    if(this._authService.isLoggedIn()){
      const tokenUser = this._encryptService.decrypt( localStorage.getItem('token') );
      console.log('tokenUser.email -- '+ tokenUser.email)
      this._userService.getUser(tokenUser.email).subscribe({
        next: (response) => {
